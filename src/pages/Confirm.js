...
export default function Confirm() {
    ...
    if (!order)
        return (_jsx("div", { className: "flex items-center justify-center h-screen bg-red-50 p-4", children: _jsxs("div", { className: "bg-white p-10 rounded-xl shadow-lg text-center", children: [_jsx("h1", { className: "text-3xl font-bold text-red-600 mb-4 font-serif", children: "\u274C Commande introuvable ou non pay\u00E9e" }), _jsx("p", { className: "mb-6", children: "Impossible d'afficher les d\u00E9tails de cette commande." }), _jsx("a", { href: "/e-shop/", className: "bg-red-600 text-white px-6 py-2 rounded", children: "Retour au panier" })] }) }));
